class Sheep {
  constructor(field, col) {
    ...
    this.pos = createVector(random(this.field.x, this.field.x + this.field.w), random(this.field.y, this.field.y + this.field.h));
  ...
  stayWithinWalls() {
    ...
    if (this.pos.x < xLow + border) desired.add(this.maxspeed, 0);
    if (this.pos.y < yLow + border) desired.add(0, this.maxspeed);
    if (this.pos.x > xHigh - border) desired.add(-this.maxspeed, 0);
    if (this.pos.y > yHigh - border) desired.add(0, -this.maxspeed);
